...
Cómo practicamos Scrum: ceremonias, acuerdos de equipo, duración de sprints y anti-patterns que queremos evitar.
...
- **Regla**: El daily es para sincronizar, no para reportar. Si algo necesita más de 2 minutos, se resuelve después con las personas involucradas
...
**Scope creep silencioso**: Si se construyó y recoger feedback
- **Quién**: Todo el equipo + stakeholders relevantes
...
## Anti-pattern**: Todo el equipo + PO
- **Output**: Sprint backlog con tareas estimadas y asignadas
